...
namespace SimpleLightProbePlacer.Editor
{
    ...
    public class LightProbeVolumeEditor : UnityEditor.Editor
    {
        ...
        private void OnSceneGUI()
        {
            ...
            float size = Mathf.Max(lightProbeVolume.Size.x, lightProbeVolume.Size.y, lightProbeVolume.Size.z) * 0.01f;

            var volume = TransformVolume.EditorVolumeControl(lightProbeVolume, size, LightProbeVolume.EditorColor);

...
public class FlockController:MonoBehaviour{
    ...
    public Vector3[] spawnSphereSetPos;
    ...
    public void AddChild(int amount){
    	...
    	for(int i=0;i<amount;i++){
            ...
            NetworkActivated networkActivated = obj.gameObject.GetComponent<NetworkActivated>();
            if (networkActivated != null)
                networkActivated.ObjectId = gameObject.name +  obj.gameObject.name + i.ToString();
    	    obj._spawner = this;
    	    _roamers.Add(obj);

...
public class OrigamiFlockController:FlockController{
   ...
   // public FlockChild _childPrefab;			// Assign prefab with FlockChild script attached
    ...
    //public List<OrigamiFlockChild> _roamers;
    ...
    public void Start() {
        waypointIdx = 0;
        spawnSphereSetPos = new Vector3[] {
            new Vector3(0f, 0f, 0f),
            new Vector3(1.2f, -2f, 0f),
            new Vector3(-.5f, 1.8f, 2.1f),
            new Vector3(-2f, 1f, -.7f),
            new Vector3(2.18f, -.4f, 1.3f),
            new Vector3(1.5f, 1.9f, -.3f),
            new Vector3(.8f, .4f, .9f),
            new Vector3(-1.6f, 1f, -2f),
            new Vector3(-1f, -.7f, -1f),
            new Vector3(0f, 0f, -1.6f),
            new Vector3(2f, -.89f, .8f),
            new Vector3(-1.9f, .35f, 1.7f),
            new Vector3(-.87f, -1.5f, -1.65f),
            new Vector3(1f, 1f, -1f),
            new Vector3(-.2f, -.95f, 2f),
            new Vector3(-2.1f, 2f, 0.5f),
            new Vector3(2f, -.6f, 0f),
            new Vector3(.1f, 1.2f, .3f),
            new Vector3(.9f, -2.1f, -1.15f),
            new Vector3(-.54f, -.25f, -1.4f),
            new Vector3(-1.25f, 1.68f, -1.9f),
            new Vector3(-1.05f, 2.19f, .75f),
            new Vector3(.7f, -.1f, 1.45f),
            new Vector3(1.8f, 1.3f, .2f),
            new Vector3(-2f, .05f, 1.1f),
            new Vector3(1.7f, -1.5f, .5f),
            new Vector3(-2.1f, 2f, 0f),
            new Vector3(0f, 1f, 0f),
            new Vector3(-.8f, .8f, 1.7f),
            new Vector3(-1.5f, 1f, 2f),
            new Vector3(1.34f, 1.2f, -1f),
            new Vector3(.4f, .5f, 0f),
            new Vector3(-1.99f, .7f, 1f),
            new Vector3(.2f, .1f, -.4f),
            new Vector3(2f, 2f, 2f),
            new Vector3(-2f, -2f, -2f),
            new Vector3(0f, 1.8f, 0f),
            new Vector3(-1.4f, -2f, .86f),
            new Vector3(-.5f, -1.76f, 1.5f),
            new Vector3(-1.8f, 2f, 2f),
    ...
    public void AddChild(int amount){
    	...
    	for(int i=0;i<amount;i++){
    		FlockChild obj = Instantiate(_childPrefab);	
    	    obj._spawner = this;
    	    _roamers.Add(obj);
    ...
    public void incrementWaypointIdx()
    {
        waypointIdx++;
    }
    ...
    public void RemoveChild(int amount){
    	for(int i=0;i<amount;i++){
    		FlockChild dObj = (OrigamiFlockChild)_roamers[_roamers.Count-1];
    ...
    //	}
    	...
    	if(_forceChildWaypoints){
    		for(int i = 0; i < _roamers.Count; i++) {
                //changed this from Random.value*_forcedRandomDelay
      		 	(_roamers[i]).Wander(0f);
    		}	
    	}
    }

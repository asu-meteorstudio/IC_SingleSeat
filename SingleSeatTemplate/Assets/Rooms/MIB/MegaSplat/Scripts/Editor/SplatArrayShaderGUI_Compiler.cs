...
public partial class SplatArrayShaderGUI : ShaderGUI 
{
   ...
   const string declareMesh            = "      #pragma surface surf Standard vertex:vert fullforwardshadows addshadow nofog finalcolor:fogcolor";
   ...
   const string declareMeshRamp       = "      #pragma surface surf Ramp vertex:vert fullforwardshadows nofog addshadow finalcolor:fogcolor";
   ...
   */
   ...
   static void WriteTessPragma(string[] features, StringBuilder sb, bool isShadow)
   {
      if (HasTessellation(features))
      {
         ...
         if (HasFeature(features, DefineFeature._INSTANCING))
         {

...
public partial class SplatArrayShaderGUI : ShaderGUI 
{
   ...
   public class FeatureData
   {
      ...
      GUIContent CShaderInstancing = new GUIContent("GPU Instancing", "Add support for GPU Instancing");
      ...
      public bool DrawGUI(Material mat, ref string shaderName)
      {
         ...
         if (MegaSplatUtilities.DrawRollup("MegaSplat Shader Compiler"))
         {
            ...
            {
               instancing = EditorGUILayout.Toggle(CShaderInstancing, instancing);
            }
      ...
      public void Unpack(string[] keywords)
      {
         ...
         instancing = (HasFeature(keywords, DefineFeature._INSTANCING));
      ...
      public string[] Pack()
      {
         ...
         if (instancing && shaderType == ShaderType.Mesh)
         {
            features.Add(GetFeatureName(DefineFeature._INSTANCING));
         }

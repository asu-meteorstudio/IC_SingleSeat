   ...
   public class NodeMegaSplatOutput : Node 
   {
      ...
      public class Job
      {
         ...
         public Bounds Init(Terrain t, NodeMegaSplatOutput masterNode)
         {
            ...
            buffer = new RenderTexture(width, height, 0, RenderTextureFormat.ARGB32, PlayerSettings.colorSpace == ColorSpace.Linear ? RenderTextureReadWrite.Linear : RenderTextureReadWrite.sRGB);
            result = new Texture2D(width, height, TextureFormat.RGB24, false, PlayerSettings.colorSpace == ColorSpace.Linear);
            fxBuffer = new RenderTexture(width, height, 0, RenderTextureFormat.ARGB32, PlayerSettings.colorSpace == ColorSpace.Linear ? RenderTextureReadWrite.Linear : RenderTextureReadWrite.sRGB);
            fxResult = new Texture2D(width, height, TextureFormat.RGB24, false, PlayerSettings.colorSpace == ColorSpace.Linear);

...
namespace JBooth.VertexPainterPro
{
   public partial class VertexPainterWindow : EditorWindow
   {
      ...
      public string[] flowTargetNames = new string[]
      {
         "ColorRG",
         "ColorBA",
         "UV0_XY",
      ...
      string[] brushTargetNames = new string[]
      {
         "Color",
         "ValueR",
         "ValueG",
         ...
         "UV3_X - Layer Blend",
         "UV3_Y - Puddles",
         "UV3_Z - Displacement Dampening",
         "UV3_W - Top Splat Index",
         #else
         "UV2_Z",
         "UV2_W",
         "UV3_X",
      ...
      #if __MEGASPLAT__
      public BrushTarget     brushMode = BrushTarget.UV3_Z;
      #else
      ...
      public FlowTarget      flowTarget = FlowTarget.UV2_ZW;
      ...
      void DrawVertexPoints(PaintJob j, Vector3 point)
      {
         ...
         for (int i = 0; i < j.verts.Length; ++i)
         {
            ...
            if (dist < bz)
            {
               ...
               #else
               Handles.SphereCap(0, point, Quaternion.identity, HandleUtility.GetHandleSize(wp) * 0.02f * showVertexSize);
               #endif

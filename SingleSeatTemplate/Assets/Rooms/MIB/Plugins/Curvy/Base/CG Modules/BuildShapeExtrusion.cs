        ...
        public override void Refresh()
        {
            ...
            else
            {
                ...
                req.Add(new CGDataRequestRasterization(
                    ...
                    Resolution, InPath.SourceSlot().OnRequestPathModule.PathLength,
                ...
                req.Add(new CGDataRequestRasterization(
                    ...
                    CrossResolution, InCross.SourceSlot().OnRequestPathModule.PathLength,
                ...
                CGShape cross = InCross.GetData<CGShape>(req.ToArray());
                ...
                //Warning messages
                {
                    ...
                    for (int index = 0; index < InCross.LinkedSlots.Count; index++)
                    {
                        ...
                        if (linkedSlot.Module is InputSplineShape)
                        {
                            ...
                            if (inputSplineModule
                                && inputSplineModule.UseCache
                                && cross.Count > inputSplineModule.Shape.CacheSize * 1.30f
                                && cross.Count > inputSplineModule.Shape.CacheSize + 30)
                ...
                CGVolume vol = CGVolume.Get(OutVolume.GetData<CGVolume>(), path, cross);
                CGVolume volHollow = (OutVolumeHollow.IsLinked) ? CGVolume.Get(OutVolumeHollow.GetData<CGVolume>(), path, cross) : null;

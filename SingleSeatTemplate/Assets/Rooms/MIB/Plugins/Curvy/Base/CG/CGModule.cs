...
#pragma warning restore 618
        ...
        {
            resource.name = string.Format(System.Globalization.CultureInfo.InvariantCulture, "{0}_{1}_{2}", ModuleName, UniqueID, resourceName);
            if (index > -1)
                resource.name += string.Format(System.Globalization.CultureInfo.InvariantCulture, "{0:000}", index);
        }

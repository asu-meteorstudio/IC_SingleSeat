...
#pragma warning restore 618
        ...
        public CurvySplineSegment[] Add(params Vector3[] controlPoints)
        {
            ...
            for (int i = 0; i < controlPoints.Length; i++)
                cps[i] = InsertAfter(null, localToWorldMatrix.MultiplyPoint3x4(controlPoints[i]), true);
        ...
        public void Clear()
        {
            ...
            for (int i = ControlPointCount - 1; i >= 0; i--)
                ...
                else
                {
                    ...
                    {
                        //BUG I am sure this fucks up somehow if the scene has an id 42. Check this potentiel issue

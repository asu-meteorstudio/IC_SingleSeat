...
#region --- CG Options ---
        ...
        */
        ...
        Vector3 interpolateBezier(float localF)
        {
            ...
            Transform ncpCachedTransform = ncp.transform;
            Vector3 localPos = transform.localPosition;
            return CurvySpline.Bezier(localPos + HandleOut,
                                      localPos,
                                      ncpCachedTransform.localPosition,
                                      ncpCachedTransform.localPosition + ncp.HandleIn,
                                      localF);
        }
        ...
        Vector3 interpolateCatmull(float localF)
        {
            ...
            Vector3 previousPosition = previousControlPoint
                ...
                : localPos;
            Vector3 nextPos = nextControlPoint.transform.localPosition;
            Vector3 nextNextPosition = nextNextControlPoint
                ? nextNextControlPoint.transform.localPosition
                : nextPos;
            return CurvySpline.CatmullRom(previousPosition,
                                          localPos,
                                          nextPos,
                                          nextNextPosition,
                                          localF);
        ...
        Vector3 interpolateTCB(float localF)
        {
            ...
            return CurvySpline.TCB(previousPosition,
                                   localPos,
                                   nextPos,
                                   nextNextPosition,
        ...
        private float InterpolateBezierSegment(CurvySpline spline, int newCacheSize)
        {
            ...
            for (int i = 1; i < newCacheSize; i++)
            {
                ...
                lengthAccumultor += tMagnitude;
                ApproximationDistances[i] = lengthAccumultor;

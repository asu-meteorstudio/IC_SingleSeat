...
namespace FluffyUnderware.Curvy.Controllers
{
    ...
    public class SplineController : CurvyController
    {
        ...
        //public UnityEvent m_onEndReachedSimple;
        [SerializeField]
        ...
        private void HandleReachingNewControlPoint(CurvySplineSegment newControlPoint, CurvyPositionMode positionMode, float currentDelta, ref bool cancelMovement)
        {
            ...
            //Debug.LogFormat("IS FIRST CP: {0}, IS LAST CP: {1}", (preAllocatedEventArgs.Spline.FirstVisibleControlPoint == preAllocatedEventArgs.ControlPoint),
            //    (preAllocatedEventArgs.Spline.LastVisibleControlPoint == preAllocatedEventArgs.ControlPoint));

            if ((preAllocatedEventArgs.Spline.FirstVisibleControlPoint == preAllocatedEventArgs.ControlPoint && Clamping == CurvyClamping.Loop) ||
                preAllocatedEventArgs.Spline.LastVisibleControlPoint == preAllocatedEventArgs.ControlPoint)
        ...
        //public void InvokeEndReachedSimple()
        //{
        //    m_onEndReachedSimple.Invoke();
        //}
